...
class QuantizableLayer(base_layer.BaseLayer):
    ...
    **Convenience functions:**
    ...
    # Not present in current Lingvo, I have added from previous version
    # earlier version of FqWeight
    def AqtWeight(self,
                  w,
                  feature_axis,
        ...
        def WrapOp(fnname, f, default_qmin=None, default_qmax=None):
            ...
            def Wrapped(*args, **kwargs):
                ...
                if qdomain is not None:
                    del kwargs['qdomain']
                narrow_to_asym_bit_depth = kwargs.get(
                    'narrow_to_asym_bit_depth')
...
class FakeQuantizationSchedule(BaseClippingCapSchedule):
    ...
    def ApplyClippingWithState(self,
        ...
        # Quantization will implicitly clip, so if we are in the
